  ...
  hardwareProjects: [
    {
      ...
      images: [
        ...
        { src: "assets/img/hw-solar-tracker-circuit.jpg", caption: "Logic circuit on breadboard" },
      ],
      materials: [
        "1× Breadboard",
        "2× MG996 Servo Motor",
    ...
    },
    {
      ...
      images: [
        ...
        { src: "assets/img/hw-fire-fighting-robot.jpg", caption: "Assembled robot" },
    ...
    },
    {
      ...
      images: [
        { src: "assets/img/hw-led-cube.jpg", caption: "Final build — multi-color animation" },
        { src: "assets/img/hw-led-cube-green.jpg", caption: "Initial build — single color test" },
